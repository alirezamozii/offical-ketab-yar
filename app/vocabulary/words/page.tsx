...
function WordsListContent() {
    ...
    // Performance Optimization: Derived state for filtered list with useMemo + debounce
    // Reduces re-renders and avoids manually syncing state via useEffect on keystrokes
