...
function WordsListContent() {
  ...
  // Bolt Optimization: Use debounced search query to prevent unnecessary re-renders on every keystroke
  ...
  // Bolt Optimization: Derive filtered list with useMemo instead of useEffect + local state
  // This prevents a double-render when the query changes and keeps state sync declarative
