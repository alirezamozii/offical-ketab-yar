...
function WordsListContent() {
    ...
    // Performance optimization: Using useMemo to prevent double-renders on derived state.
    // Derived state like filtered data should be memoized, not kept in separate useState synchronized via useEffect.
