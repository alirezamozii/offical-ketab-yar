...
function WordsListContent() {
    ...
    // Use useMemo instead of useState and useEffect to prevent redundant re-renders and recalculations
    const filteredWords = useMemo(() => {
        if (!searchQuery) {
            return words
        }

        // Hoist the lowerCase computation outside the filter loop for better performance
