    ...
    <Card className="group transition-shadow hover:shadow-md">
      <CardContent className="p-4">
        <div className="space-y-3">
          ...
          {/* Context */}
          {word.context && <p className="text-xs italic text-muted-foreground">"{word.context}"</p>}
          ...
          {word.status === 'mastered' && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="flex items-center justify-center gap-1 text-sm font-medium text-green-600"
            >
