  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gold: "border-transparent bg-gold-100 text-gold-800 dark:bg-gold-900 dark:text-gold-300",
      },
    },
    defaultVariants: {
      variant: "default",
...
export interface BadgeProps
  ...
  variant?: "default" | "secondary" | "destructive" | "outline" | "success" | "error" | "warning" | "gold"
}
