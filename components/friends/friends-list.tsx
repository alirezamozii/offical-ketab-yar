...
import { BookOpen, Flame, Loader2, Trophy, UserMinus, Users } from 'lucide-react'
  ...
  if (friends.length === 0) {
    return (
      <div className="py-12 text-center">
        ...
        <h3 className="mb-2 text-lg font-semibold">هنوز دوستی ندارید</h3>
        <p className="mb-4 text-muted-foreground">از بخش جستجو کاربران جدید را پیدا کنید</p>
      </div>
    )
  }
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Button asChild variant="outline" size="sm">
              <Link href={`/friends/${friend.username || friend.friend_id}`}>مشاهده پروفایل</Link>
            </Button>
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  ...
                  aria-label={`حذف ${friend.username || friend.friend_id} از دوستان`}
                >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    آیا مطمئن هستید که می‌خواهید {friend.full_name || friend.username} را از لیست
                    دوستان خود حذف کنید؟
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
