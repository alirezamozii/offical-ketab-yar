      ...
      >
        <div className="w-full max-w-7xl mx-auto px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <Button variant="ghost" size="sm" onClick={() => setShowSubtitles(!showSubtitles)} className={showSubtitles ? "bg-black/10 dark:bg-white/10" : ""} aria-label="Toggle subtitles">
              <Type className="h-4 w-4" />
            </Button>

            <Button variant="ghost" size="sm" onClick={() => { setShowHighlights(!showHighlights); setShowSettings(false); }} aria-label="Toggle highlights">
            ...
            <Button variant="ghost" size="sm" onClick={() => setShowChat(!showChat)} aria-label="Toggle chat">
              <MessageSquare className="h-4 w-4" />
            </Button>

            <Button variant="ghost" size="sm" onClick={() => { setShowSettings(!showSettings); setShowHighlights(false); }} aria-label="Toggle settings">
