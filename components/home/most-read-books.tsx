...
export async function MostReadBooks() {
  try {
    ...
    // ⚡ Bolt Optimization: Removed JSON.parse(JSON.stringify()) serialization
    // Next.js App Router natively supports passing plain JS objects from Server to Client components.
    // This avoids unnecessary CPU overhead and garbage collection from deep cloning.
