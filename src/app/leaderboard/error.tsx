...
/**
 * /leaderboard error boundary — catches errors on the leaderboard page.
 * The leaderboard reads from `/api/leaderboard` (which is hardened
 * against read-only DB failures by A7), so an unhandled error here is
 * rare; this boundary is a safety net.
 */
export default function LeaderboardError({
  ...
  useEffect(() => {
    console.error('[ketab-yar] /leaderboard error boundary:', {
  ...
  return (
    ...
    >
      ...
      <h1 className="mt-6 text-2xl font-extrabold tracking-tight sm:text-3xl">
        جدول رده‌بندی بارگذاری نشد
      </h1>
      <p className="mt-3 max-w-md text-pretty text-muted-foreground">
        در نمایش رده‌بندی کاربران مشکلی پیش آمد. این مشکل معمولاً موقتی است —
        لطفاً دوباره تلاش کنید. اگر مشکل ادامه داشت، به خانه برگردید.
      </p>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
        <Button
          ...
          variant="glow"
          size="lg"
          aria-label="تلاش دوباره برای بارگذاری رده‌بندی"
        >
